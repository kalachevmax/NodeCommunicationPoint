...
ncp.db.mongo.Client.prototype.__send = function(request) {
  if (request instanceof ncp.db.mongo.SetRequest) {
    this.__sendSetRequest(request);
  }

  if (request instanceof ncp.db.mongo.GetRequest) {
 ...
 * @inheritDoc
 */
ncp.db.mongo.Client.prototype.get = function(ns, key, complete, cancel) {
  this.__requests.push(ncp.db.mongo.createGetRequest(
      ns, key, complete, cancel));
 ...
 * @inheritDoc
 */
ncp.db.mongo.Client.prototype.remove = function(ns, key, complete, cancel) {
